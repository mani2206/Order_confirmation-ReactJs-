    ...
    <nav className="navbar navbar-light bg-light">
      <div className="container-fluid">
        <a className="navbar-brand">
          {" "}
          <img className="logo1" src="../.././images/logo.webp" alt="logo" style={{width:"85px"}} />
        </a>

        <ul className="navbar-nav mr-auto mt-2 mt-lg-0  flex-row ">
          <li className="nav-item px-md-4 font_phone">
            <a className="nav-link" href="#">
              ...
              <span className="px-2">9177362777</span>
            </a>
          </li>
          <li className="nav-item font_message">
            <a className="nav-link" href="#">
              ...
              <span className="px-2">itsupport@Driverlogistics.In</span>
            </a>
          </li>
        </ul>
      </div>
